(function () {
    ...
    api.runtime.onMessage.addListener((req, sender, sendResponse) => {
        ...
        if (req.action === "prepare") {
            // Inject Scrollbar Hiding CSS globally to target all scrollable elements
            ...
            // Keep overflow untouched to prevent scroll-locking programmatic APIs,
            // while CSS takes care of keeping the capture clean and scrollbar-free.
